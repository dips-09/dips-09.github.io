...
<br />
My current position is as a Senior Solution Consultant in Acideas Solution Private Limited (CRMNext) since October 2021. I'm adept at business process redesign, roadmap planning, and managing stakeholder discussions to deliver successful CRM projects. 
The core competencies I've acquired while serving this role are problem solving, Data Modeling, Business Intelligence & ETL, Power BI, JIRA, Azure DevOps, Apex Programming, JS Frameworks, Lightning Web Components, Salesforce Development, App Builder,
Testing Tools, Positive Attitude, Drive To Succeed, Ability To Motivate, Ability To Learn Quickly and Presentation Skills.

Prior to that I served as Software Engineer at Cognizant Technology Solutions where I have gained experience in maintaining and upgrading existing legacy code/systems. I bring robust analytical skills and a problem-solving mindset. The technologies that I have professional experience in are: Java, C#, JavaScript, ReactJS, HTML, CSS, SQL Server, .NET Core, Git, JQuery, AJAX and Azure Cloud. 
